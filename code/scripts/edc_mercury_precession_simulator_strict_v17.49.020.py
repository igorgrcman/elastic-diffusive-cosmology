...
"""edc_mercury_precession_simulator.py — STRICT (v17.49.020)
...
def main():
    ...
    parser.add_argument("--ci", action="store_true", help="CI mode: run convergence test and exit 0/2 accordingly.")
    ...
    print("=" * 60)
    print("EDC MERCURY PRECESSION SIMULATOR — STRICT (v17.49.020)")
    print("=" * 60)
