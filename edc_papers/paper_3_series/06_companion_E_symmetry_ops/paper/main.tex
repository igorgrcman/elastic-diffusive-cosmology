...
\input{sections/02_geometric_setup}
\input{sections/03_symmetry_layering}
\input{sections/04_defect_classification}
\input{sections/05_process_operators}
\input{sections/06_beta_decay_ledger}
...
\input{appendices/B_claim_registry}
