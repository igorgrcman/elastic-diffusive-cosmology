...
\subsection{Structural Comparison with Fermi Form}
...
\begin{equation}
  ...
  \label{eq:L_fermi}
\end{equation}
we define the \textbf{EDC structural analog} \tagDef{}:
\begin{equation}
  \boxed{
  ...
  \label{eq:G_EDC}
\end{equation}
where $g_{\mathrm{eff}}$ is an effective coupling that absorbs overlap and
boundary-condition factors (full decomposition in \S\ref{sec:geff}).
...
Companion V (DOI: \href{https://doi.org/10.5281/zenodo.18321383}{10.5281/zenodo.18321383}) $\cdot$
