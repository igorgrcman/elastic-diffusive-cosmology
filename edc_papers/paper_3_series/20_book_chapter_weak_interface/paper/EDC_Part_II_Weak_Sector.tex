...
\midrule
\multicolumn{3}{l}{\textbf{Identified/Calibrated (\tagI{})}} \\[2pt]
$E_{\text{disl}} = 1.293$ MeV & Mass difference from defect & 2 \\
$r_e \approx 1$ fm & Lattice spacing & 2, 3 \\
$\sigma r_e^2 = 5.86$ MeV & Hexagonal cell energy & 2, 3 \\
\midrule
\multicolumn{3}{l}{\textbf{Open (\tagOpen{})}} \\[2pt]
Lepton mass hierarchy & $m_e : m_\mu : m_\tau$ & --- \\
Neutrino mass scale & Edge mode mechanism & --- \\
Koide formula phase & $\mathbb{Z}_3$ origin? & --- \\
V$-$A quantitative & Mode solutions needed & --- \\
\bottomrule
\end{tabular}
\end{center}
