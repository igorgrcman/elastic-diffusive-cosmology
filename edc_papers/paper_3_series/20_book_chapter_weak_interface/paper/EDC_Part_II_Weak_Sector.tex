...
% Note: This requires extracting the content from Z6_PROGRAM_COMPLETE_DERIVATION.tex
% For now, we include it as a standalone section
\input{Z6_content}
...
\midrule
RT-CH3-001 & V$-$A from Plenum Inflow & HIGH & OPEN \\
RT-CH3-002 & $G_F$ from 5D Mediator & HIGH & OPEN \\
RT-CH3-003 & Neutron Lifetime from Peierls Barrier & HIGH & OPEN \\
...
These targets are documented in the \texttt{research\_targets/} directory with
explicit INPUT/OUTPUT specifications and success criteria.
