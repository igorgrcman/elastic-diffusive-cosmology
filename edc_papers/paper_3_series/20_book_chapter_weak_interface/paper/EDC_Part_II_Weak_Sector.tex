...
\vspace{0.3cm}
\noindent\textbf{Epistemic Classification of Results:}
\vspace{0.2cm}
...
$\sin^2\theta_W = 1/4$ (bare) & $\mathbb{Z}_6$ subgroup counting & 2, 3 \\
$\sin^2\theta_W(M_Z) = 0.2314$ & + Standard RG running & 3 \\
$g^2 = 0.4246$ (1.1\% err) & Electroweak relation & 3 \\
$M_W = 80.2$ GeV (0.2\% err) & From $g$ and $v$ & 3 \\
$G_F$ (exact) & Self-consistent & 3 \\
$\tau_n \approx 830$ s (6\% err) & WKB tunneling & 2, 3 \\
Proton stability & $\mathbb{Z}_3$ fixed point & 2 \\
120° Steiner angles & $\mathbb{Z}_6 \Rightarrow$ equal tensions & 2 \\
\midrule
...
Lepton masses, neutrinos, Koide, V$-$A & Future work & --- \\
\bottomrule
\end{tabular}
\end{center}
...
\item Not all parameters are from first principles---some are calibrated (marked).
\item We do not claim completeness---open problems are listed.
