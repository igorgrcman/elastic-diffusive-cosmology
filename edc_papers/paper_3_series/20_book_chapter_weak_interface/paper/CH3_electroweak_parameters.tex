...
\tagDc{}
\textit{(See also Theorem~\ref{thm:weinberg_angle} in Chapter~2 for the foundational proof.)}
...
\tagDc{}
\textit{(See also Theorem~\ref{thm:neutron_lifetime} in Chapter~2 for the geometric derivation.)}
