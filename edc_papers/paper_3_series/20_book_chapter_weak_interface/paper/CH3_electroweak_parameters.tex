...
\textbf{The Physics of Running:}

The Weinberg angle runs because $g$ and $g'$ have different beta functions:
\begin{itemize}
\item $g'$ (hypercharge) increases toward higher energies
\item $g$ (weak isospin) changes more slowly
\item Their ratio, which determines $\sin^2\theta_W$, therefore changes
\end{itemize}
