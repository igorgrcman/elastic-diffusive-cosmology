...
\paragraph{Option 1: $A_\mu$ zero-mode (even, Neumann).}
...
\paragraph{Option 2: $A_5$ component (odd, Dirichlet).}
...
\paragraph{Option 3: KK $A_\mu$ excitation (even, Neumann, $n = 1$).}
...
If SU(2)$_L$ is brane-localized (\S\ref{sec:ch9_su2l_embedding}), the gauge fields
