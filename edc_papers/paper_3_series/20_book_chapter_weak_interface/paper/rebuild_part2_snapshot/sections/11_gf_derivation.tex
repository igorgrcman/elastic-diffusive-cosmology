...
% ==============================================================================
% FULL CLOSURE PLAN: Non-circular target formula for G_F (OPR-22)
% ==============================================================================
\input{sections/ch11_gf_full_closure_plan}

% ==============================================================================
% VALUE CLOSURE ATTEMPT: g_5 and ell from membrane parameters (OPR-19/20)
% ==============================================================================
\input{sections/ch11_g5_ell_value_closure_attempt}

% ==============================================================================
% COEFFICIENT PROVENANCE: Deriving the 4pi factor (OPR-19 Attempt 2)
% ==============================================================================
\input{sections/ch11_g5_value_closure_attempt2_coefficient}

% ==============================================================================
% 4pi DERIVATION: Dual-route derivation (OPR-19 Attempt 3)
% ==============================================================================
\input{sections/ch11_g5_value_closure_attempt3_derive_4pi}

% ==============================================================================
% SUPPRESSION MECHANISM ATTEMPT: Deriving f_geom << 1 (OPR-20 follow-up)
% ==============================================================================
\input{sections/ch11_g5_ell_suppression_attempt2}

% ==============================================================================
% FACTOR-8 FORENSIC: BC eigenvalue + junction + R_xi rescale (OPR-20 forensic)
% ==============================================================================
\input{sections/ch11_opr20_factor8_forensic}

% ==============================================================================
% GEOMETRIC FACTOR-8: Attempt C - Derive factor from EDC geometry (OPR-20)
% ==============================================================================
\input{sections/ch11_opr20_geometric_factor8_attemptC}

% ==============================================================================
% OPR-20 Attempt D: R_ξ Interpretation + Robin from Junction + Overcounting Audit
% ==============================================================================
\input{sections/ch11_opr20_attemptD_interpretation_robin_overcount}

% ==============================================================================
% OPR-20 Attempt E: Prefactor-8 First-Principles Derivation
% ==============================================================================
...
% ==============================================================================
% OPR-20 Attempt G: Derive α from EDC Brane Physics
% ==============================================================================
\input{sections/ch11_opr20_attemptG_derive_alpha_from_action}

% ==============================================================================
% OPR-20 Attempt G_BC: Boundary Condition Provenance
% ==============================================================================
\input{sections/ch11_opr20_attemptG_BC_provenance}

% ==============================================================================
% OPR-20 Attempt H: Derive δ = R_ξ from Part I Brane Microphysics
% ==============================================================================
\input{sections/ch11_opr20_attemptH_delta_equals_Rxi}

% ==============================================================================
% OPR-20a Attempt H1: Mediator Field Identity → BC Provenance
% ==============================================================================
