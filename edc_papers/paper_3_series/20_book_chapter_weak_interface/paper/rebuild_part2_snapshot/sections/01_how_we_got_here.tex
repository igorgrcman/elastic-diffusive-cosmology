% ==============================================================================
% Section 1.2: How We Got Here
% ==============================================================================

\section{From 5D Relaxation to Brane-Interface Mechanics}
...
without inserting small numbers by hand (open).
...
studies (Sections~\ref{sec:case_neutron}--\ref{sec:case_neutrino}). The key insight is that they all share a
...
coupling (see Chapter~\ref{ch:electroweak}): one couples a brane-facing current $J(x)$
...
The mechanistic program is formalized as the \textbf{unified pipeline} in
Section~\ref{sec:unified_pipeline}: Absorption $\to$ Dissipation $\to$ Release,
with ledger closure and explicit projection operators. That section provides
the canonical definitions; case studies then apply the pipeline with
