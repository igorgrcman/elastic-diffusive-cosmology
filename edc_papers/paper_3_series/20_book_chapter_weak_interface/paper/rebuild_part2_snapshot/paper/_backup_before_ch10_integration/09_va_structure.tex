...
\subsection{The Standard Model Approach}
...
\midrule
\multicolumn{3}{l}{\textit{Derived consequences (the ``THEN'' part):}} \\
$m(z) > 0$ for $z > 0$ & From inflow direction & \tagDc{} \\
$f_L$ localized at boundary & Mathematical consequence & \tagDc{} \\
$f_R$ suppressed at boundary (half-line: non-norm.) & Domain-dependent & \tagDc{} \\
