...
% Status: YELLOW — Critical insight on phase cancellation; Z₂ selection improves $\delta$
% ==============================================================================
...
\paragraph{\texorpdfstring{Key finding: M3 (single $\mathbb{Z}_2$ sign flip).}{Key finding: M3 (single Z2 sign flip).}}
...
\subsubsection{Inter-sector Bridge: $\sqrt{2}$ Connection}

\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!60!black,
    title=\textbf{$\sqrt{2}$ Bridge: CKM--PMNS Connection [OPEN]}]
The same $\sqrt{2}$ factor appears in PMNS mixing:
\begin{itemize}[nosep]
    \item PMNS Attempt~4.1: $\varepsilon = \lambda/\sqrt{2}$ gives $\sin^2\theta_{13}$
    \item PMNS Attempt~4.2: $\theta_{12} = \arctan(1/\sqrt{2}) = 35.26°$ gives solar angle
\end{itemize}

The CKM CP phase involves $\tan\delta = \sqrt{3} \cdot (\text{overlap ratios})$, where
$\sqrt{3}/2 = \sin 60°$ emerges from the $\mathbb{Z}_6$ structure.

\textbf{Observation:} $\sqrt{2}$ (PMNS) and $\sqrt{3}$ (CKM) are the diagonal and
face-diagonal of a unit cube---both arise naturally from $\mathbb{Z}_6$ geometry.

\textbf{Open question:} Is there a unified geometric origin connecting
$\varepsilon_{\text{PMNS}} \sim 1/\sqrt{2}$ and $\delta_{\text{CKM}} = 60°$?
This inter-sector relationship remains \textbf{[OPEN]} for future work.
\end{tcolorbox}

% ==============================================================================
% Z2 PARITY ORIGIN: Geometric derivation of sign-selection rule (OPR-11)
% ==============================================================================
\input{sections/ch7_z2_parity_origin}
