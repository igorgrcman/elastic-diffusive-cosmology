...
\paragraph{\texorpdfstring{Route A: Z$_2$ Orbifold (Two-Sided Bulk).}{Route A: Z2 Orbifold (Two-Sided Bulk).}}
...
\paragraph{\texorpdfstring{Key finding: $2\pi\sqrt{2} \approx 8.89$.}{Key finding: 2pi*sqrt(2) approx 8.89.}}
