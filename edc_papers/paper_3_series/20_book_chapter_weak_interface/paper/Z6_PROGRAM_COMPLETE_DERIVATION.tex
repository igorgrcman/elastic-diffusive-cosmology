...
% Date: January 2026
% Status: FORMAL DERIVATION RECORD
% ==============================================================================
...
\title{%
  ...
  From Hexagonal Packing to $SU(3)$ Emergence}
}
\author{Igor Grčman\\
\textit{Elastic Diffusive Cosmology Research Program}\\
\texttt{igor.grcman@edc-research.org}
}
...
neutron-proton mass difference; (3) interpretation of three fermion generations
as radial harmonics of the $\mathbb{Z}_3$ vortex, consistent with the Koide formula.
...
$\tau_n$ from tunneling rate & \tagI{}/\tagOpen{} & Needs Peierls barrier \\
...
\begin{enumerate}
  ...
  \item Quantitative calculation of Peierls barrier for neutron lifetime
\end{enumerate}
