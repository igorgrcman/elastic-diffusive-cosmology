...
an underlying combinatorial structure. This is \tagOpen{} for future work:
...
Koide phase derived & \tagOpen{} (not yet) \\
\bottomrule
\end{tabular}
\end{center}
...
$G_F$ from overlap integral & \tagOpen{} & Order-of-magnitude, needs refinement \\
