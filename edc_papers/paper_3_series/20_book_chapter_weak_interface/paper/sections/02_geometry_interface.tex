% ==============================================================================
% Section 2: Geometry and Interface
% ==============================================================================
...
If we parameterize the fifth dimension by a coordinate $y$, then surfaces of
constant $y$ are 4D hypersurfaces. But the geometry is richer: 4D submanifolds
can have arbitrary orientations, curvatures, and embeddings \tagDef{}.
...
\begin{enumerate}
  ...
  \item \textbf{Ledger Closure} \tagDef{}:
...
The geometry-interface picture sets up the stage for the unified pipeline:
\begin{itemize}
  \item The thick brane provides the arena for absorption, dissipation, and release.
  \item The boundary conditions determine which modes can couple and which outputs
        are allowed.
  \item The viability filter explains why our universe has the particular structure
        it does.
\end{itemize}

The next section formalizes the pipeline in terms of energy flow, operators, and
regime parameters.
