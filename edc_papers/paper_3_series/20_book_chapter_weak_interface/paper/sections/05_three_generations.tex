...
$|\mathbb{Z}_3| = 3 \to N_{\text{gen}}$ & No & \textcolor{red!80!black}{\textbf{RED}} & Cardinality matching, not derivation \\
...
Barrier form specified & No & \textcolor{red!80!black}{\textbf{RED}} & $V(z)$ not derived from EDC action \\
Lifetime calculation & No & \textcolor{red!80!black}{\textbf{RED}} & No explicit $S_n$ computed \\
Cutoff at $n = 3$ & No & \textcolor{red!80!black}{\textbf{RED}} & Would need specific barrier height \\
\bottomrule
\end{tabular}
\end{center}
...
\textbf{Criterion} & \textbf{Met?} & \textbf{Stoplight} & \textbf{Comment} \\
\midrule
$M_5$ topology specified & No & \textcolor{red!80!black}{\textbf{RED}} & EDC bulk metric not fully constrained \\
$\pi_1(M_5)$ computed & No & \textcolor{red!80!black}{\textbf{RED}} & No calculation exists \\
Winding $\to$ generation & No & \textcolor{red!80!black}{\textbf{RED}} & Mechanism not worked out \\
...
\midrule
A: $\mathbb{Z}_3 \subset \mathbb{Z}_6$ & Partial \tagI{} & No & \textcolor{orange!80!black}{\textbf{YELLOW}} \\
B: KK truncation & No \tagP{} & No & \textcolor{red!80!black}{\textbf{RED}} \\
C: $\pi_1(M_5) = \mathbb{Z}_3$ & No \tagP{} & No & \textcolor{red!80!black}{\textbf{RED}} \\
\bottomrule
\end{tabular}
\end{center}
