...
infinitely thin---it has a finite thickness $\delta$ along the fifth dimension $z$,
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Radial structure:} Real fermion profiles depend on both
          $\xi$ (angular) and $z$ (radial/depth) coordinates. The toy model
...
radial coordinate $z$. Fermions localized near $z = 0$ (observer face).
}}
...
% ==============================================================================
\subsection{\texorpdfstring{Candidate Mechanism C: Bulk Topology $\pi_1(M_5)$}{Candidate Mechanism C: Bulk Topology pi1(M5)}}
