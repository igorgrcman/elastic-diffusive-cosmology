...
Left-handed fermions are trapped at $z \approx 0$ (the observer-facing brane boundary)
by the asymmetric mass profile. Their wavefunction $f_L(z)$ is sharply peaked with
...
The effective 4D coupling involves integrating four fermion mode functions over $z$:
$G_F \sim G_5 \int |f_L(z)|^4 dz$. Because $f_L(z)$ is tightly localized, this
...
\textbf{Left panel:} Plot of $f_L(z)$ vs $z$:\\
$\bullet$ Sharp peak at $z = 0$ (observer boundary)\\
$\bullet$ Exponential decay into brane layer\\
$\bullet$ Width $\sigma_L \sim 1/m_0 \sim$ 1 fm\\[0.5em]
\textbf{Right panel:} Plot of $|f_L(z)|^4$ vs $z$:\\
$\bullet$ Even sharper peak (fourth power concentrates the function)\\
$\bullet$ Shaded area = $I_4 = \int |f_L|^4 dz \sim m_0$\\
