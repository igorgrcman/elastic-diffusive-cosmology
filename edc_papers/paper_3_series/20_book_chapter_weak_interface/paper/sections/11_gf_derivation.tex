...
5D coupling $g_5$ & Action normalization & \tagP{} & RED-C \\
Mediator mass $m_\phi$ & $\xi$-geometry KK reduction & \tagP{} & RED-C \\
Mode profiles $f_L(z)$ & Thick-brane BVP & (open) & RED-C \\
First-principles $G_F$ & Complete derivation & (open) & RED-C \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
First-principles $G_F$ & RED-C & (open) \\
\bottomrule
\end{tabular}
\end{table}
