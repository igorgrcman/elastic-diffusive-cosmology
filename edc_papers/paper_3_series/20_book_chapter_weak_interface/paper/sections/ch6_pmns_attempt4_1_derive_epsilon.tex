...
This does not rule out the $\kappa$ mechanism entirely; it indicates that either
(a)~the $\kappa$ ratio estimate needs refinement, or (b)~an additional factor is
present. This is tracked as OPR-10.
