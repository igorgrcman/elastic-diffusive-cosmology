...
\begin{itemize}[nosep]
    ...
    \item \textbf{5D coordinate:} Paper~2 uses $\xi$ for the extra dimension;
          Book Part~II uses $z$ for the same physical coordinate.
          \textbf{Correspondence:} $z \equiv \xi_{\text{Paper\,2}}$
\end{itemize}
For dimensionless coordinates in BVP problems, we define $\tilde{z} = z/\ell \in [0,1]$,
