...
\textit{Latest:} OPR-19 4$\pi$ derivation: $C=4\pi$ \textbf{YELLOW [Dc]+[P]}; $g^2 = 0.373$ (6\% from SM). OPR-20 Attempt D: $R_\xi$ interpretation [P], Robin structure [Dc] (params [P]), overcounting audit confirms $2\pi\sqrt{2}$ valid (factor-8 naive combinations INVALID). Status: RED-C [Dc]+[OPEN].
}}
\end{center}
