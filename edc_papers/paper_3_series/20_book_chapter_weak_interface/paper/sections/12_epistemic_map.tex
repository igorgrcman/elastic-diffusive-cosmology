...
OPR-05 & PMNS mixing angles & RED (open) & PMNS Attempt 2 \\
...
\begin{itemize}[nosep]
    \item \textcolor{OliveGreen}{\textbf{Closed:}} Baseline DFT falsification; breaking requirements quantified \tagDc{}
    \item \textcolor{YellowOrange}{\textbf{Partial:}} Mass suppression mechanism (edge-mode overlap) \tagP{}
    \item \textcolor{BrickRed}{\textbf{Open:}} Mixing angles; CP phase; Dirac vs Majorana
\end{itemize}
...
\textbf{P1-B: PMNS Mixing (OPR-05, OPR-08)}
\begin{itemize}[nosep]
    \item \emph{Status:} DFT baseline falsified; $\sim$25\% breaking quantified
    \item \emph{Next:} Attempt~2 analogous to CKM overlap model
    \item \emph{Payoff:} Closes neutrino flavor sector
\end{itemize}
