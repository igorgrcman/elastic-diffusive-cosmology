...
\textit{$G_F$:} sanity skeleton complete (chain map + dimensional pass); first-principles closure remains \textbf{RED-C} pending OPR-19/20/21.
\textbf{Hard blockers (P1):} OPR-02/21 thick-brane BVP; OPR-19 canonical $g_5$ normalization; OPR-20 KK spectrum for $m_\phi$; OPR-22 combine without SM circularity.
}}
\end{center}
