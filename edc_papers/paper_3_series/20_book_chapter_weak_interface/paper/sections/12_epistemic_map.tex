...
\textit{Latest:} OPR-20 Attempt F: Mediator BVP + junction$\to$Robin [Dc]; \textbf{broad region} $\alpha \in [5.5, 15]$ (47\% of scanned range) produces $x_1 \approx 2.5$---NOT needle-tuned; $\alpha$ derivation remains [OPEN]. Status: RED-C [Dc]+[OPEN].
}}
\end{center}
