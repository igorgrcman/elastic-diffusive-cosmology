...
\textit{Latest:} OPR-20 suppression mechanism (Attempt A2): Candidate A ($f = R_\xi/r_e \sim 10^{-3}$) is SM-free [P] but overshoots $M_W$ by 8$\times$.
}}
\end{center}
...
\begin{itemize}[nosep]
    ...
    \item \emph{Suppression attempt (OPR-20):} Candidate A ($f = R_\xi/r_e \sim 10^{-3}$) is SM-free [P], but predicts $m_\phi \approx 620$ GeV (8$\times$ overshoot). Factor-8 discrepancy unresolved.
