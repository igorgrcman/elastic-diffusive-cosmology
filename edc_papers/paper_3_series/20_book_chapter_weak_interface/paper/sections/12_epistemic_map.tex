...
\textit{Latest:} OPR-19 4$\pi$ derivation (Attempt 3): Dual-route via Gauss+isotropy $\to$ $C=4\pi$ \textbf{YELLOW [Dc]+[P]}; $g^2 = 0.373$ (6\% from SM). OPR-20 factor-8 remains RED-C [OPEN].
}}
\end{center}
