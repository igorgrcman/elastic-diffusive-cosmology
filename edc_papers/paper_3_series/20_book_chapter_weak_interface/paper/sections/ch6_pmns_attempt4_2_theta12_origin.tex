...
\subsection{Attempt 4.2: θ$_{12}$ Origin Micro-Attempt}
...
\paragraph{T1: $\theta_{12} = \arctan(1/\sqrt{2})$.}
...
\paragraph{T2: $\theta_{12} = 45° - \arcsin(\lambda)$.}
...
unified $\sqrt{2}$ factor with $\varepsilon = \lambda/\sqrt{2}$; OPR-05c
