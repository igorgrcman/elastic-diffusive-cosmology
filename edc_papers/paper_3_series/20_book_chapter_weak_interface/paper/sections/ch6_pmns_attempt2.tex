...
% OPR-05 status: YELLOW (upgraded from RED)
% ==============================================================================
...
% ------------------------------------------------------------------------------
\subsubsection{Implications for OPR-05}
\label{sec:ch6_opr05_update}

The PMNS Attempt 2 results upgrade OPR-05 from RED to \textbf{YELLOW} with a
computed partial success:

\begin{tcolorbox}[colback=orange!5, colframe=orange!50!black,
    title=\textbf{OPR-05 Status Update}]
...
\textbf{Epistemic upgrade:} OPR-05 now YELLOW with explicit breaking requirements.
\end{tcolorbox}
...
\paragraph{Candidate mechanisms for $\theta_{12}$.}
