...
\begin{edcDefinitionBox}{Mode Index}{[Def]/[P]}
...
\begin{edcDefinitionBox}{Allowed Output Sets for Tau Leptonic Decays}{[Def]/[Dc]}
...
\begin{edcPostulateBox}{Mode-Spectrum Branching}{[P]/[OPEN]}
...
\paragraph{Why are BR($\tau \to e$) and BR($\tau \to \mu$) nearly equal?}
