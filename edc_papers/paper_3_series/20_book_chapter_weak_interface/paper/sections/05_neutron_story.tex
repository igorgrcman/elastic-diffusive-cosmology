...
\begin{edcDefinitionBox}{Neutron state as a junction excitation}{[Def]/[Dc]}
...
thick-brane microphysics \tagOpen{}.

\paragraph{Release (observer-facing projection) \tagDef{}/\tagDc{}.}
...
\begin{edcDefinitionBox}{Regime switch / trigger (neutron)}{[Def]/[Dc]}
...
\begin{edcDefinitionBox}{Kinematic allowance criterion}{[Def]/[BL]}
...
\end{equation}
Each term is non-negative except $E_{\mathrm{bulk,res}}$, which parameterizes any residual bulk-side mismatch \tagOpen{}.
...
\begin{figure}[ht]
\centering
\input{figures/fig_neutron_process_pipeline.tex}
