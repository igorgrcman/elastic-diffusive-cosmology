...
\begin{description}[style=nextline, leftmargin=1em, font=\normalfont\bfseries]
    ...
    \item[Attempt 3: CP phase ansatz \tagDc{}/\tagI{}:]
        Illustrative phase ansatz gives $J = 2.9 \times 10^{-5}$ (PDG: $3.1 \times 10^{-5}$).
        Note: pure $\mathbb{Z}_3$ charges give $J = 0$ (Phase Cancellation Theorem).
...
Why quarks $\neq$ leptons ($\kappa_q/\kappa_\ell$) & YELLOW & \tagI{} \\
\textbf{Attempt 3: Jarlskog $J$ magnitude} & \textcolor{YellowOrange}{\textbf{YELLOW}} & \tagDc{}/\tagI{} \\
...
CP phase $\delta$ (60° vs 65°) & \textcolor{YellowOrange}{\textbf{YELLOW}} & \tagDc{}/\tagI{} \\
CP factor $(\bar\rho, \bar\eta)$ derivation & RED & (open) \\
\bottomrule
\end{tabular}
\end{table}
