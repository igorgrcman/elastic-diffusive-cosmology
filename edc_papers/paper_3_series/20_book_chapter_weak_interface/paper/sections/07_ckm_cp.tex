...
\begin{description}[style=nextline, leftmargin=1em, font=\normalfont\bfseries]
    ...
    \item[Open:]
        Resolve 2.5$\times$ discrepancy; 5D BVP for $f_i(z)$; CP phase $\delta$; Jarlskog $J$.
\end{description}
\end{tcolorbox}
...
\begin{enumerate}[nosep]
    ...
    \item \textbf{Remaining open:}
          Resolve 2.5$\times$ discrepancy; 5D BVP for profiles; CP phase; Jarlskog $J$.
\end{enumerate}
\end{tcolorbox}
...
$|V_{ub}|$ prediction ($2.5\times$ off) & YELLOW & \tagDc{} \\
