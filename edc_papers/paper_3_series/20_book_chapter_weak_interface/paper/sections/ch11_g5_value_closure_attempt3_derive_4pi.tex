...
\paragraph{\texorpdfstring{Why not $2\pi$ or $\pi$?}{Why not 2pi or pi?}}
...
\paragraph{\texorpdfstring{Mode normalization on $S^2$.}{Mode normalization on S2.}}
...
\paragraph{\texorpdfstring{Why not $2\pi$ or other factors?}{Why not 2pi or other factors?}}
...
\paragraph{\texorpdfstring{What selects $4\pi$ uniquely.}{What selects 4pi uniquely.}}
