...
$\theta_{12} \approx 33°$ & RED & (open) & Not derived \\
$\theta_{23} \approx 45°$ & RED & (open) & Not derived \\
$\theta_{13} \approx 8.5°$ & RED & (open) & Not derived \\
...
PMNS mixing mechanism & RED & \tagP{} \\
Dirac/Majorana prediction & RED & (open) \\
\bottomrule
\end{tabular}
\end{table}
...
$\mathbb{Z}_3$ \tagI{}, but leaves mixing angles and mass hierarchy as
open problems \tagP{}/(open).
