...
\begin{edcDefinitionBox}{Three-Layer Ontology}{[Def]}
\begin{enumerate}[nosep]
...
\begin{edcDefinitionBox}{Energy Partition for Muon Decay}{[Def]}
\begin{align}
...
\begin{edcDefinitionBox}{Allowed Output Set for Muon Decay}{[Def]/[Dc]}
...
\begin{edcDefinitionBox}{Chiral Filter Decomposition}{[Def]/[P]}
