...
\begin{edcPostulateBox}{Projection Mechanism for Helicity Suppression}{[P]/[OPEN]}
...
\begin{edcPostulateBox}{Metastability Mechanism}{[P]/[OPEN]}
...
\begin{edcDefinitionBox}{Allowed Outputs for $\pi^+$ Decay}{[Def]/[Dc]}
