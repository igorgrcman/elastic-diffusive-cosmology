...
\begin{enumerate}[nosep]
    \item Full SU(2)$_L$ gauge embedding with W$^\pm$, Z$^0$ mass generation
    \item CKM/PMNS mixing from generational mode overlaps
    \item Quantitative $G_F$ from thick-brane profile (see Ch.~11)
    \item Neutrino mass and Majorana vs.\ Dirac structure
