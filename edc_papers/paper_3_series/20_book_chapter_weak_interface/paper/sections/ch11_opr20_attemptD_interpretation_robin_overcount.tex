...
\paragraph{Interpretation A1: $R_\xi$ as Radius.}
...
\paragraph{Interpretation A2: $2\pi R_\xi$ as Circumference.}
...
\paragraph{Interpretation A3: $R_\xi$ as Diffusion Length (Boundary Layer).}
...
\paragraph{Physical Interpretation of $\kappa$.}
...
\paragraph{Key Redundancy: Z$_2$ $\equiv$ Israel Junction.}
...
\paragraph{Detailed Check: $2 \times 4$ Overcounting.}
