% ==============================================================================
% Paper 3-2.0: EDC Weak Sector — Journal-Style Umbrella Document
% Version: 2.0 (Supersedes narrative integration from Weak Program Overview)
% Date: 2026-01-20
...
\title{%
  ...
  \large Mechanistic Brane Pipeline, Ontology Map,\\
  and Structural Pathway to \texorpdfstring{$G_F$}{GF}
}
\author{%
  Igor Grčman\\
  \small Elastic Diffusive Cosmology Collaboration
}
\date{January 2026 \quad v2.0}
...
\begin{tcolorbox}[edcWarning, title={Supersede Notice}]
This paper \textbf{supersedes the narrative integration role} of the
Weak Program Overview (DOI: 10.5281/zenodo.18319921). All companion documents
remain archival modules with their own DOIs; this paper provides the unified
journal-style presentation. The Overview remains valid as a quick-reference
index.
\end{tcolorbox}
...
\begin{figure}[ht]
\centering
\input{../figures/fig_unified_pipeline}
...
\begin{figure}[ht]
\centering
\input{../figures/fig_ontology_map}
...
\noindent\textit{Document version: 2.0}\\
\textit{Generated: January 2026}\\
\textit{This paper supersedes the narrative integration role of Weak Program
Overview; all companions remain archival modules with DOIs.}
