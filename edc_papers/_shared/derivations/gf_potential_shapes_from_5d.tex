% =============================================================================
% gf_potential_shapes_from_5d.tex
% =============================================================================
% Derivation: BVP Potential Shapes from 5D Action Reduction
% Issue: OPR-21c — Derive V(χ) shapes from 5D physics
% Status: [Dc] — Derived Conditional (specific gauge choices assumed)
%
% Companion: docs/GF_POTENTIAL_SHAPES_FROM_5D_NOTE.md
% =============================================================================
...
\title{BVP Potential Shapes from 5D Action Reduction\\[0.5em]
\large Connecting Background Geometry to Mode Localization}
\author{EDC Project}
\date{2026-01-29}
...
\begin{abstract}
We derive the 1D Schrödinger-like potential $V(\chi)$ appearing in the BVP
mode equation from 5D brane-world actions. Three background types are analyzed:
Gaussian wall, Randall-Sundrum-like warp, and domain wall (tanh). The key
result is that \textit{any} localized brane produces an attractive potential
well near $\chi = 0$, leading to bound fermion modes. The potential depth
scales as $1/\delta^2$ where $\delta$ is the brane thickness.
\end{abstract}
