...
\textbf{Result:} Three independent gates PASS simultaneously at tuned parameters.
This is \textbf{non-trivial}: each gate tests a different aspect of the mode-overlap mechanism.
...
\midrule
Gate 1 & $I_4$ overlap window & $2.08 \times 10^{-3}$ GeV & \textcolor{OliveGreen}{\textbf{PASS}} \\
