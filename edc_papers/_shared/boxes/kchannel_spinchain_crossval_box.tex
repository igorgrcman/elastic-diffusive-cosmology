...
\vspace{0.2em}
\textit{Source: companion repository.}\footnote{Repository artifacts: \texttt{spin\_chain\_kchannel\_ed\_test.py}, \texttt{SPIN\_CHAIN\_KCHANNEL\_CROSSVALIDATION.md}}
