...
%-----------------------------------------------------------------------------
% P79 SMOKE-TEST WARNING BANNER (Layer B only)
%-----------------------------------------------------------------------------
\begin{tcolorbox}[colback=yellow!10!white,colframe=red!75!black,title=\textbf{INTEGRATION SMOKE TEST --- NOT PHYSICAL CLOSURE}]
\textbf{WARNING:} The numeric values in this section are \textbf{SMOKE-TEST} outputs for pipeline validation only.

\textbf{Do NOT cite these values} unless the imported \texttt{sigma\_tilde\_value.json} satisfies ALL criteria for REAL provenance (see \texttt{SMOKE\_TEST\_POLICY.md}).

\textbf{Current mode:} SMOKE (SHA256: see recompute output)
\end{tcolorbox}
%-----------------------------------------------------------------------------
