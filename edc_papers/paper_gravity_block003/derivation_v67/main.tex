...
%-----------------------------------------------------------------------------
% P81 REAL MODE BANNER (Layer B only) — replaces P79 SMOKE banner
%-----------------------------------------------------------------------------
\begin{tcolorbox}[colback=green!10!white,colframe=green!50!black,title=\textbf{REAL MODE --- PROVENANCE SEALED}]
\textbf{Status:} The $\tilde{\sigma}$ import satisfies all REAL provenance criteria.

\textbf{Provenance identifiers:}
\begin{itemize}
  \item \texttt{derivation\_ref}: \texttt{EDC-COSMO-TSTAR-5D-ROUTEAB}
  \item \texttt{git\_commit}: \texttt{e41a228b226aebb10e406c93d57eca6e601b11a4}
  \item \texttt{sot\_hash}: \texttt{edc\_cosmo\_tstar\_5d\_e41a228}
\end{itemize}

\textbf{Citation:} Layer B numeric values may be cited as physical closure (see \texttt{ACTIVATION\_GATE.md}).
\end{tcolorbox}
%-----------------------------------------------------------------------------
