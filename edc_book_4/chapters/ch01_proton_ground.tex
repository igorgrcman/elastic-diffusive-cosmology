...
The anchor junction is the lightest baryonic configuration. Experimental searches constrain
its lifetime:
\begin{equation}
...
\begin{edcopenbox}[title=Falsifiability Hooks]
    \begin{itemize}
        ...
        \item If baryonic matter can be destabilized by small perturbations without
