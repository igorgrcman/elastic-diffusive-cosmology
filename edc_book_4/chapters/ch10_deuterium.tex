...
\begin{definition}[Contact Patch]
    ...
    coordination shells of two adjacent junctions. Within this region:
    \begin{itemize}
...
\begin{derivationbox}[title=Argument B: Minimal Closure in Dual Lattice]
    ...
    \textbf{Cross-check:} The M$_6$ dual lattice is locally tetrahedral.
    A two-vertex edge of a tetrahedron subtends 3 faces---consistent
