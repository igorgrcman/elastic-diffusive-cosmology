...
(Chapter~\ref{ch:M6_lattice}), structural strain modifies the effective barrier.
...
(Chapter~\ref{ch:junction_symmetries}). Since $\text{Z}_6 \cong \text{Z}_2 \times \text{Z}_3$,
