...
\begin{resultbox}
    ...
    (Appendix~\ref{app:P2_N7_core}); bulk gravitational backreaction (N2)
    is structurally $\kappa_5^2$-suppressed---cross-term and LO self-energy
    reduce to tension renormalization, and NLO shape corrections require
    $\Mfive \lesssim 100\MeV$ for relevance
