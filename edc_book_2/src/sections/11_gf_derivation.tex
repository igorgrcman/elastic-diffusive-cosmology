...
For an exponential profile, $I_4 = m_0$ exactly (see \S\ref{sec:ch3_electroweak}).
...
$\bullet$ Decay scale $\sim 1/m_0 \sim$ 1 fm\\[0.5em]
\textbf{Right panel:} Plot of $|f_L(\xi)|^4$ vs $\xi$:\\
$\bullet$ Even sharper peak (fourth power concentrates the function)\\
$\bullet$ Shaded area = $I_4 = \int |f_L|^4 d\xi = m_0$ (exact for exponential)\\
$\bullet$ Arrow: ``4-fermion contact = overlap of 4 mode functions''\\[0.5em]
Annotation: Tighter localization $\Rightarrow$ larger $m_0$ $\Rightarrow$ larger $I_4$ \tagM{}.
}}
...
derived from membrane physics. This is the subject of Chapter~\ref{ch:bvp_workpackage}
(BVP Work Package), which sets up the numerical infrastructure for OPR-21.
