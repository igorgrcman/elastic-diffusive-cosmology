...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!50!black,
    title=\textbf{Box 14.2: Physical $\mu$-Sweep Results (OPEN-22-4b / 4b.1)}]
...
\begin{itemize}[nosep]
    ...
    \item Boundary condition: Neumann ($\kappa = 0$)
...
\begin{tabular}{lcc}
\toprule
\textbf{Quantity} & \textbf{Range (Neumann, $\rho=0.2$)} & \textbf{Status} \\
\midrule
...
\begin{itemize}[nosep]
    ...
    \item Convergence verified: $<1\%$ drift in $x_1$, $|f_1(0)|^2$, $G_{\text{eff}}$ at $N_{\text{grid}} = 4000$
    \item Robin BC ($\kappa > 0$) gives $|f_1(0)|^2 \to 0$ (numerically unstable, not converged)
\end{itemize}
