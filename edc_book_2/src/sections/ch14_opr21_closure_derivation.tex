...
$N_{\text{bound}} = 3$ for $\mu \in [25, 35)$. Substituting~(\ref{eq:opr21:mu_sigmaDelta}):
\begin{equation}
    25 \leq \frac{\sqrt{3}}{2}\, y \, n \, \sqrt{\sigma \Delta^3} < 35
    \label{eq:opr21:Nbound3_geometric}
\end{equation}

Solving for $\sigma \Delta^3$ (assuming $y = 1$, $n = 4$ as reference values):
\begin{equation}
    \boxed{\sigma \Delta^3 \in [52, 102] \quad \text{(in natural units, for } y=1, n=4 \text{)}}
