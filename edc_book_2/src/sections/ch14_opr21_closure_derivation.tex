...
\textbf{Evidence files:} See companion repository.\footnote{Repository artifacts: \texttt{audit/evidence/OPR21\_*.md} reports and \texttt{code/opr21\_bvp\_physical\_run.py}.}
\end{tcolorbox}
...
\begin{tcolorbox}[breakable, enhanced, colback=green!5!white, colframe=green!50!black,
    title=\textbf{Canonical Physical Path (WD) --- Reader Route Map}, width=\linewidth]
...
\textbf{Cross-reference:} See \S\ref{ch:ch15_opr01} for the full derivation
of the $\sigma \to M_0$ relation from domain-wall kink theory.
\end{tcolorbox}

\paragraph{Step-by-step substitution.}
From OPR-01 (\S\ref{ch:ch15_opr01}), the domain-wall kink derivation yields \tagDc{}:
\begin{equation}
...
\begin{tcolorbox}[breakable, enhanced, colback=yellow!5!white, colframe=orange!50!black,
    title=\textbf{Parameter Ledger: Before and After OPR-01}, width=\linewidth]
...
\begin{tcolorbox}[breakable, enhanced, colback=red!5!white, colframe=red!50!black,
    title=\textbf{Remaining Open Items (after OPR-01)}, width=\linewidth]
\begin{enumerate}[nosep]
...
\begin{tcolorbox}[breakable, enhanced, colback=gray!5!white, colframe=gray!50!black,
    title=\textbf{Reproducibility: Numerical Pipeline}, width=\linewidth]
...
\textbf{Outputs:} JSON summary, phase diagram, and robustness table in companion repository.\footnote{Repository artifacts: \texttt{code/output/opr21\_physical\_*.json/.md}}
...
See companion repository for full analysis.\footnote{Repository artifacts: \texttt{audit/evidence/OPR21R\_MU\_WINDOW\_SHAPE\_DEPENDENCE\_REPORT.md} and \texttt{code/opr21r\_mu3\_scan.py}}
...
$M_0 = f(\sigma, \Delta, y)$ & \tagDc{} DERIVED & OPR-01 CLOSED (\S\ref{ch:ch15_opr01}) \\
...
\begin{tcolorbox}[breakable, enhanced, colback=blue!5!white, colframe=blue!50!black,
    title=\textbf{Box 14.2: Physical $\mu$-Sweep Results --- Green Path Family}, width=\linewidth]
...
See companion repository.\footnote{Repository artifact: \texttt{audit/evidence/OPEN22\_4bR\_PHYSICAL\_ROBIN\_AUDIT.md}}
...
\textbf{Evidence}: See companion repository.\footnote{Repository artifacts: \texttt{audit/evidence/OPEN22\_4bR\_PHYSICAL\_ROBIN\_AUDIT.md}, \texttt{code/open22\_4bR\_phys\_robin\_sweep.py}}
\end{tcolorbox}
