...
\label{subsec:neutrino_stoplight}

\begin{tcolorbox}[colback=yellow!10!white, colframe=orange!60!black,
    title=\textbf{Case Neutrino: Stoplight Verdict}]
...
\midrule
Edge-mode ontology & \textcolor{YellowOrange}{\textbf{YELLOW}} & \tagP{} \\
Mass suppression mechanism & \textcolor{YellowOrange}{\textbf{YELLOW}} & \tagDc{} \\
Ledger closure partner & \textcolor{OliveGreen}{\textbf{GREEN}} & \tagDc{} \\
V--A from chirality filter & \textcolor{OliveGreen}{\textbf{GREEN}} & \tagDc{} \\
\bottomrule
\end{tabular}
\end{center}

\textbf{Overall: YELLOW} --- Mass suppression mechanism identified; quantitative
derivation requires overlap integrals from BVP.

\textbf{Blockers:}
\begin{itemize}[nosep]
\item Neutrino mass scale from 5D geometry
\item PMNS matrix derivation (see Chapter~\ref{ch:neutrinos_edge})
\item Edge-mode localization profile
\end{itemize}
