...
\label{thm:steiner}% Alias for legacy references
...
Appendix~\ref{sec:DL-bc-sign-analysis} (BC Sign and Minimum Analysis).
\end{tcolorbox}
...
Independent \textbf{Route B} (see Derivation Library, ``Z$_6$ Steiner Route'') derives the same 120° junction
