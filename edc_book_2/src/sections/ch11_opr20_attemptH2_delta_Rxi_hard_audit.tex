...
\begin{itemize}[nosep]
    \item $\xi$-axis (transverse dimension) with brane at $\xi = 0$
    \item Bulk region ($\xi > \delta$): field in bulk-dominated regime
    \item Boundary layer ($0 < \xi < \delta$): field transitions to brane mode
    \item Brane surface ($\xi = 0$): Robin BC applies
