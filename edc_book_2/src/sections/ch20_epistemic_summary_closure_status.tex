...
\textbf{Audit evidence}: This chapter was verified against the epistemic tagging system.
\end{tcolorbox}
...
Full registry: see the OPR Summary in Appendix~\ref{sec:DL-opr-registry}.
\end{tcolorbox}
...
All audit evidence (OPR derivation reports and verification logs) is maintained
alongside the reproducible code in the repository.
