...
\begin{itemize}[nosep]
    \item $\delta = R_\xi$ identification: assumption (A2)---plausible but not proven from action \tagP{}/[OPEN]
...
\textbf{Scale notation:} $\delta$ = boundary-layer scale, $\ell$ = domain size, $\Delta$ = kink width.
See Scale Taxonomy, Chapter~16, \S\ref{sec:ch16_reader_map} for canonical definitions and assumptions (A1)--(A3).
