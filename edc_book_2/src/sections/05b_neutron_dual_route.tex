...
\label{eq:M_NG}
\end{equation}
where $\tau_{\mathrm{eff}} \approx 70\,\mathrm{MeV/fm}$ is the effective string tension and
$L_{\mathrm{leg}}(q) = \sqrt{L_0^2 + q^2}$ is the leg length.
...
$\tau_{\mathrm{eff}}$ & $70\,\mathrm{MeV/fm}$ & \tagDc{} & Eq.~(\ref{eq:M_NG}) & $M_{\mathrm{NG}}(q)$ \\
