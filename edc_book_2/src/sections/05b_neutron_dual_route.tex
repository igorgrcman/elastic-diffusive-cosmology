...
``pancake'' junction core), not a derivation. See supporting document in
companion repository.\footnote{Repository artifact: \texttt{derivations/DELTA\_ANCHOR\_MAP.md}}
\end{tcolorbox}
