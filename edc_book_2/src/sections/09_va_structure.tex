...
\subsubsection{Connection to BVP Framework}

The chirality asymmetry ratio $R_{\text{LR}}$ is defined in the BVP framework
(Chapter~\ref{ch:bvp_framework}). The overlap integrals
$I_4$ and related quantities can be computed once the BVP is solved with
a derived $V(\xi)$.

\paragraph{Cross-references.}
\begin{itemize}[nosep]
    \item BVP specification and closure criteria: Chapter~\ref{ch:bvp_framework}
    \item Full closure pack details: Derivation Library, ``BVP Closure Pack''
\end{itemize}
