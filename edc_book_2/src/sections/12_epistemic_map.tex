...
\end{itemize}
A pre-publication checklist must be completed before any public release.
\end{tcolorbox}

% ==============================================================================
% k-channel Cross-Validation Box (2026-01-29)
% ==============================================================================
\input{\EDCPAPERS/_shared/boxes/kchannel_spinchain_crossval_box}

% ==============================================================================
% G_F BVP All-Gates Pass + Physical Priors Box (2026-01-29)
% ==============================================================================
\input{\EDCPAPERS/_shared/boxes/gf_bvp_allgates_physical_priors_box}

% ==============================================================================
% CONSOLIDATED GATE REGISTRY (2026-01-29)
% Single-source table of all gates used in Book 2
% ==============================================================================
\subsection{Consolidated Gate Registry}
\label{sec:gate_registry}

The following table consolidates all verification gates used throughout Part~II.
Each gate represents a specific test or threshold that must be satisfied.

\begin{center}
\small
\begin{tabular}{@{}llllp{4cm}@{}}
\toprule
\textbf{Gate ID} & \textbf{Description} & \textbf{Location} & \textbf{Status} & \textbf{Notes} \\
\midrule
\multicolumn{5}{l}{\textbf{Electroweak Parameters}} \\
\midrule
GF-1 & $\sin^2\theta_W = 1/4$ & \S\ref{ch:z6_program} & \textcolor{OliveGreen}{PASS} & Z$_6$ counting [Der] \\
GF-2 & $g^2$ from $\sigma r_e^3$ & \S\ref{ch:electroweak} & \textcolor{OliveGreen}{PASS} & 1.1\% after RG [Dc] \\
GF-3 & $M_W$ prediction & \S\ref{ch:electroweak} & \textcolor{OliveGreen}{PASS} & 0.2\% after RG [Dc] \\
\midrule
\multicolumn{5}{l}{\textbf{BVP / Mode Structure}} \\
\midrule
BVP-1 & $N_{\text{bound}} = 3$ & Ch14 & \textcolor{OliveGreen}{PASS} & Physical domain wall [Dc] \\
BVP-2 & BC robustness & Ch14 & \textcolor{OliveGreen}{PASS} & Robin $\hat\kappa \in [0,2]$ [Dc] \\
BVP-3 & Convergence $<1\%$ & Ch14 & \textcolor{OliveGreen}{PASS} & 0.22\% achieved [Dc] \\
BVP-4 & No-smuggling & Ch14--19 & \textcolor{OliveGreen}{PASS} & No SM inputs used \\
\midrule
\multicolumn{5}{l}{\textbf{Kinematic Selection}} \\
\midrule
Q-Gate & Energy threshold & \S1.5 & \textcolor{OliveGreen}{PASS} & $n \to p + e^-$ only [BL] \\
Mode-Gate & Topological selection & \S1.5 & \textcolor{OliveGreen}{PASS} & $\mu \not\to$ hadrons [I] \\
\midrule
\multicolumn{5}{l}{\textbf{Open / Partial Gates}} \\
\midrule
OPR-19 & $g_5$ from action & Ch17 & \textcolor{YellowOrange}{YELLOW} & Spine [Dc], closure [OPEN] \\
OPR-20 & $m_\phi$ eigenvalue & Ch18 & \textcolor{YellowOrange}{YELLOW} & Spine [Dc], closure [OPEN] \\
OPR-22 & $G_{\text{eff}}$ formula & Ch19 & \textcolor{YellowOrange}{YELLOW} & Formula [Dc], inputs [P] \\
\bottomrule
\end{tabular}
\end{center}

\textbf{Legend:}
\textcolor{OliveGreen}{PASS} = Gate satisfied with explicit derivation or verification.
\textcolor{YellowOrange}{YELLOW} = Partial closure; derivation spine exists but inputs remain [P] or [OPEN].
\textcolor{BrickRed}{FAIL/RED} = Gate not satisfied or approach falsified.

% ==============================================================================
% SCALE DISAMBIGUATION (2026-01-29)
% ==============================================================================
\input{_shared/scale_disambiguation_box}

% ==============================================================================
% OVERLAP INTEGRAL CANONICAL DEFINITION (2026-01-29)
% ==============================================================================
\input{_shared/overlap_integral_canon}
...
\midrule
OPR-02 & KK tower truncation (N$_{\text{gen}}$) & RED-C [P] & BVP spectral count + robustness (see Chapter~\ref{ch:bvp_framework}) \\
...
\begin{itemize}[nosep]
    \item \emph{Status:} Full closure plan complete (see Chapter~\ref{ch:coupling_chain}); \textbf{OPR-22 upgraded to YELLOW [Dc]+[OPEN]}
