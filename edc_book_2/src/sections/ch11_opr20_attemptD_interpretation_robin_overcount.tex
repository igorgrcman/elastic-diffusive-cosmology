...
\begin{enumerate}[nosep]
    \item \textbf{Brane tension coupling:} If the brane tension $\sigma$ couples to $\phi$,
          then $\kappa \sim \sigma/M_{5,\mathrm{Pl}}^3$ where $M_{5,\mathrm{Pl}}$ is the 5D Planck scale.
...
$M_{5,\mathrm{Pl}} \sim 10^{16}$ GeV. This gives:
\begin{equation}
    \kappa \sim \frac{\sigma}{M_{5,\mathrm{Pl}}^3} \sim \frac{10^{14}}{10^{48}} \text{ GeV}^{-2}
    \sim 10^{-34} \text{ GeV}^{-2}
...
Exact 8 (origin TBD) & 8 & 77.5 & $-3\%$ & [OPEN] \\
