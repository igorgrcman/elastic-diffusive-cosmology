...
\subsection{\texorpdfstring{$G_F$}{GF} Sanity Skeleton: Chain, Dimensions, and Open Inputs}
...
Mode profiles $f_L(\xi)$ & Thick-brane BVP & (open) & OPR-21: not solved \\
Overlap integral $I_4$ & $\int |f_L|^4 d\xi$ & (open) & Requires OPR-21 \\
\bottomrule
\end{tabular}
\end{table}
...
\paragraph{\texorpdfstring{What plays the role of $M$?}{What plays the role of M?}}
...
\begin{itemize}[nosep]
    ...
    \item OPR-21: Mode profiles $f_L(\xi)$ from solved thick-brane BVP
...
21 & $f_L(\xi)$ & Solve $[\partial_\xi^2 - m(\xi)^2]f = \lambda f$ with BCs & Normalized profiles \\
