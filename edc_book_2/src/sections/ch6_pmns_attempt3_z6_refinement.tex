...
\subsection{\texorpdfstring{Attempt 3: Z$_6$ Discrete-Phase Refinement}{Attempt 3: Z6 Discrete-Phase Refinement}}
\label{sec:pmns_attempt3}

Having achieved partial success in Attempt~2 (Section~\ref{sec:ch6_pmns_attempt2}) with
...
\paragraph{\texorpdfstring{Strategy B1: Scale $O_{03}$ entry.}{Strategy B1: Scale O03 entry.}}
...
\paragraph{\texorpdfstring{Strategy B2: Vary localization scale $\kappa$.}{Strategy B2: Vary localization scale kappa.}}
...
OPR-13 status: remains \textbf{YELLOW}. The atmospheric angle $\theta_{23}$ is derived~[Dc],
