...
\usepackage{adjustbox}     % For scaling wide content to fit margins
...
% Path root for external shared content (edc_papers/_shared/)
% Use: \input{\EDCPAPERS/_shared/derivations/...}
...
% Formal proof environments (Lemma, Theorem, Corollary)
...
\input{sections/04c_routeB_z6_steiner}
...
% ═══════════════════════════════════════════════════════════════════════════════
% BVP WORK PACKAGE (UNNUMBERED — infrastructure intro)
% NOTE: This is an "infrastructure interlude" (unnumbered, non-technical).
%       It provides BVP specification context before the numbered OPR chapters.
%       The chapter gap between Ch13 and Ch14 is intentional — Ch14 starts
%       with ch14_bvp_closure_pack.tex (OPR-21).
% ═══════════════════════════════════════════════════════════════════════════════
\chapter*{BVP Work Package: Thick-Brane Solver}
\addcontentsline{toc}{chapter}{BVP Work Package (Infrastructure)}
...
% -----------------------------------------------------------------------
% CHAPTER 14: OPR-21 BVP CLOSURE PACK
% -----------------------------------------------------------------------
\input{sections/ch14_bvp_closure_pack}

% -----------------------------------------------------------------------
% CHAPTER 15: OPR-01 SIGMA ANCHOR (derives M₀ from σ, feeds into OPR-21)
% -----------------------------------------------------------------------
...
% -----------------------------------------------------------------------
% OPR-20 MEDIATOR MASS FROM EIGENVALUE (Sturm-Liouville spectrum)
% -----------------------------------------------------------------------
\input{sections/ch18_opr20_mediator_mass_from_eigenvalue}

% -----------------------------------------------------------------------
% OPR-22 EFFECTIVE FERMI COUPLING FROM 5D EXCHANGE
% -----------------------------------------------------------------------
...
% ═══════════════════════════════════════════════════════════════════════════════
% TEASER: NUCLEAR APPLICATIONS (BOOK 3 PREVIEW)
% ═══════════════════════════════════════════════════════════════════════════════
...
\begin{center}
\small
\begin{tabular}{@{}lp{4.5cm}lp{3.8cm}@{}}
\toprule
\textbf{ID} & \textbf{Problem} & \textbf{Priority} & \textbf{Status} \\
\midrule
RT-CH3-001 & V$-$A from Plenum Inflow & HIGH & DERIVED (qualitative) \\
RT-CH3-002 & $G_F$ from 5D Mediator & HIGH & DERIVED (order-of-mag.) \\
RT-CH3-003 & Neutron Lifetime from Peierls Barrier & HIGH & \textbf{DERIVED (6\%)} \\
...
% ═══════════════════════════════════════════════════════════════════════════════
% DERIVATION LIBRARY APPENDIX
% All technical derivations from edc_papers/_shared/ collected for reference
% ═══════════════════════════════════════════════════════════════════════════════
