...
\noindent{\footnotesize $^\dagger$Using $M_W = gv/2$, the expression $G_F = g^2/(4\sqrt{2}M_W^2)$ reduces identically to $G_F = 1/(\sqrt{2}v^2)$. Hence $G_F$ is fixed by the baseline input $v$ \tagBL{} and is \emph{not} an independent geometric prediction.}
