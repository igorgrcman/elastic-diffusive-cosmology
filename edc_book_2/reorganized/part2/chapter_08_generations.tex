...
densest 2D circle packing. This lattice has $\mathbb{Z}_6$ rotational symmetry \tagDc{}.
...
Requires deriving $V(\xi)$ from the EDC action (OPR-12).
...
$\mathbb{Z}_6$ from hexagonal packing & \tagDc{}/\tagP{} & 2D packing + energy min \\
