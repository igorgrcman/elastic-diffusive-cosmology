...
Empirical measurement or consensus value used as reference (e.g.\ CODATA/PDG tables).
...
% ============================================================
% BASELINE CONSTANTS TABLE
% ============================================================

\subsection*{Baseline Constants}
\label{sec:baseline_constants}

All empirical comparisons in this work use values from Table~\ref{tab:baseline_constants} 
...
\begin{itemize}
\item All statements ``$[\text{quantity}]_{\text{exp}} = [\text{value}]$ [BL]'' reference this table
\item Update table if newer PDG/CODATA releases are adopted
\item Single authoritative source prevents inconsistencies
\end{itemize}

% ============================================================
% LATEX MACROS (Optional - can go in preamble)
% ============================================================

% Uncomment if using macros throughout document:
%
...
% \newcommand{\Credm}{C_{\mathrm{red}}^{(m)}}
% \newcommand{\Credalpha}{C_{\mathrm{red}}^{(\alpha)}}
